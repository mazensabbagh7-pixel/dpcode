        ...
        {visibleToastLayout.items.map(({ toast, visibleIndex, offsetY }) => {
          ...
          return (
            ...
            >
              ...
              <Toast.Content
                className={cn(
                  "pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm data-expanded:opacity-100",
          ...
          .map((toast) => {
            ...
            return (
              ...
              >
                <Toast.Root
                  className={cn(
                    "relative text-balance border bg-popover not-dark:bg-clip-padding text-popover-foreground text-xs before:pointer-events-none before:absolute before:inset-0 before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
                    tooltipStyle
